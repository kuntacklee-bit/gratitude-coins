...
export default function App() {
  ...
  return (
    <div style={S.app}>
      ...
      {/* ── 네비 ── */}
      <nav style={S.nav}>
        {[{id:'home',l:'홈',ic:'🏠'},{id:'send',l:'보내기',ic:'🎁'},{id:'history',l:'내역',ic:'📋'},{id:'ranking',l:'랭킹',ic:'🏆'},{id:'admin',l:'관리',ic:'⚙️',adm:true}].map(t=>(
          <button key={t.id}
            style={{...S.navBtn,...(view===t.id?(t.adm?S.navAdmActive:S.navActive):{}),...(t.adm?{color:view===t.id?'#f87171':'#7f1d1d'}:{})}}
